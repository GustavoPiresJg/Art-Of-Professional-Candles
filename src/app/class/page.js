...
useEffect(() => {
  ...
  const playerSrc = "https://scripts.converteai.net/b6983c31-9e45-4de6-9678-d272c2ce100c/players/69b447546b51229fda290510/v4/player.js";
  const existingPlayerScript = document.querySelector(`script[src="${playerSrc}"]`);
  if (!existingPlayerScript) {
    const s = document.createElement("script");
    s.src = playerSrc;
    s.async = true;
    s.dataset.vturb = "69b447546b51229fda290510";
    document.head.appendChild(s);
  }

  if (!window._plt) {
    window._plt = window.performance && window.performance.timeOrigin
    ...
    <>
      ...
      <section className="hero">
        <div className="container hero-grid">
          <div className="hero-left hero-left--single">
            <h1 className="hero-title">
              Some women who have never worked outside the home are making  <span className="highlight-money">$5,000 a month</span>  with candles just melt, mix, and pour into a jar.
            </h1>

            <p className="hero-text hero-text--subheadline">
              No need to know how to sell or show up online. The course teaches you everything   from making your first candle to getting your first sales.
            </p>

            <div className="hero-video">
              <vturb-smartplayer
                id="vid-69b447546b51229fda290510"
                className="hero-vturb-player"
              ></vturb-smartplayer>
            </div>
      ...
      <footer className="site-footer" aria-label="Footer">
        <div className="container site-footer-inner">
          ...
          <div className="site-footer-links" role="navigation" aria-label="Footer links">
            <button type="button" className="site-footer-link" onClick={() => open("privacy")}>
              Privacy Policy
            </button>
            <button type="button" className="site-footer-link" onClick={() => open("terms")}>
              Terms of Service
            </button>
            <button type="button" className="site-footer-link" onClick={() => open("refund")}>
              Refund Policy
            </button>
          </div>
          ...
          <img className="site-footer-cards" src="/cards.webp" alt="Accepted payment methods" />
            ...
            <PolicyModal open={!!modal} title={title} onClose={close}>
...
function PrivacyPolicyContent() {
  ...
  return (
    <>
      ...
      <p>
        This Privacy Policy describes how 2B DIGITAL LLC ("Company", "we", "us", or "our") collects,
        uses, and protects your information when you access the Art of Professional Candles website
        and related digital products (the "Services").
      </p>
      ...
      <ul>
        <li>Name</li>
        <li>Email address</li>
        <li>Billing information (processed by Hotmart)</li>
      ...
      <ul>
        ...
        <li>Purchase the course via Hotmart</li>
        <li>Contact customer support</li>
      </ul>
      <p>Payment data is processed directly by Hotmart, and we do not store full payment card information.</p>
      ...
      <ul>
        ...
        <li>Send updates related to your purchase</li>
      ...
      <ul>
        <li>Hotmart (for payment processing and product delivery)</li>
        <li>Email marketing platforms</li>
        <li>Website analytics providers</li>
        <li>Legal authorities if required by law</li>
      </ul>
      <p>All third-party providers are expected to maintain confidentiality and security standards.</p>
      ...
      <p>You may disable cookies through your browser settings, but some website features may not function properly.</p>
      ...
      <p>However, no online transmission is 100% secure. You use the website at your own risk.</p>
      ...
      <p>By using the website, you consent to the transfer and processing of your information in accordance with this Privacy Policy.</p>

      <h3>11. Children's Privacy</h3>
      <p>This website and course are not intended for individuals under 18 years of age.</p>
      <p>We do not knowingly collect personal data from minors.</p>

      <h3>12. Changes to This Privacy Policy</h3>
      <p>We may update this Privacy Policy at any time.</p>
      <p>Changes will be effective immediately upon posting on this page.</p>
...
function RefundPolicyContent() {
  ...
  return (
    <>
      ...
      <h3>1. Overview</h3>
      <p>
        This Refund Policy applies to the purchase of the Art of Professional Candles course and any related
        digital products offered by 2B DIGITAL LLC.
      </p>
      <p>By purchasing our product, you agree to the terms outlined below.</p>

      <h3>2. 7-Day Money-Back Guarantee</h3>
      <p>We offer a 7-day unconditional money-back guarantee.</p>
      <p>
        If you are not satisfied with your purchase, you may request a full refund within 7 days from the date of purchase.
        No explanation is required.
      </p>

      <h3>3. How to Request a Refund</h3>
      <p>All purchases are processed through Hotmart.</p>
      <p>To request a refund:</p>
      <ul>
        <li>Log in to your Hotmart account</li>
        <li>Go to your purchase area</li>
        <li>Select the product</li>
        <li>Click on “Request Refund”</li>
        <li>Follow the platform instructions</li>
      </ul>
      <p>Refund requests must be submitted directly through Hotmart within the 7-day guarantee period.</p>
      ...
      <ul>
        ...
        <li>The request is submitted through the Hotmart platform</li>
      </ul>
      <p>Refund requests made after the 7-day period will not be approved.</p>

      <h3>5. Processing Time</h3>
      <p>Refund processing times are handled by Hotmart and may vary depending on:</p>
      <ul>
        <li>Payment method</li>
        <li>Financial institution</li>
        <li>Country of purchase</li>
      </ul>
      <p>2B DIGITAL LLC does not control payment processing timelines.</p>

      <h3>6. Access After Refund</h3>
      <p>Once a refund is approved:</p>
      <ul>
        <li>Your access to the course will be revoked</li>
        <li>Any licenses granted for use of the materials will be terminated</li>
      </ul>
      <p>
        Continued use, download, sharing, or distribution of course materials after receiving a refund is strictly prohibited.
      </p>

      <h3>7. Abuse of Policy</h3>
      <p>
        We reserve the right to deny future purchases or access to individuals who abuse the refund policy.
        Fraudulent behavior, chargebacks without following the official refund process, or unauthorized use of the content
        may result in permanent restriction.
      </p>

      <h3>8. Contact Information</h3>
      <p>
        If you have questions about this Refund Policy, you may contact:
        <br />
        2B DIGITAL LLC
        <br />
        Support: Please contact us through the support channel provided at checkout (Hotmart).
...
function TermsOfServiceContent() {
  ...
  return (
    <>
      ...
      <h3>1. Overview</h3>
      <p>
        These Terms of Service ("Terms") govern your access to and use of the website and services provided by 2B DIGITAL LLC,
        including the Art of Professional Candles course and any related digital products (collectively, the "Services").
      </p>
      <p>
        By accessing this website or purchasing any product, you agree to be bound by these Terms. If you do not agree,
        do not use this website or purchase any products.
      </p>

      <h3>2. Company Information</h3>
      <p>
        This website and its products are owned and operated by:
        <br />
        <strong>2B DIGITAL LLC</strong>
      </p>
      <p>All references to "Company", "we", "us", or "our" refer to 2B DIGITAL LLC.</p>

      <h3>3. Digital Product &amp; Course Access</h3>
      <p>The Art of Professional Candles course is a digital educational product. Upon purchase, access is granted through the Hotmart platform.</p>
      <p>You are responsible for:</p>
      <ul>
        <li>Providing accurate purchase information</li>
        <li>Accessing your product through the email used at checkout</li>
        <li>Maintaining the confidentiality of your login credentials</li>
      </ul>
      <p>We are not responsible for access issues caused by incorrect email information provided during checkout.</p>

      <h3>4. Payments</h3>
      <p>
        All payments are processed securely through Hotmart. We do not directly collect or store your payment details.
        Payment processing, billing, and transaction security are handled by Hotmart in accordance with their own terms and policies.
      </p>
      <p>By purchasing, you also agree to Hotmart’s terms and conditions.</p>

      <h3>5. 7-Day Guarantee &amp; Refund Policy</h3>
      <p>
        We offer a 7-day unconditional refund guarantee, in accordance with Hotmart’s policy.
        If you are not satisfied with your purchase, you may request a refund within 7 days of the purchase date directly
        through the Hotmart platform. After the 7-day period has expired, refunds will not be granted.
      </p>

      <h3>6. Intellectual Property</h3>
      <p>
        All content included in the course and on this website — including but not limited to videos, text materials, graphics,
        logos, branding, and downloadable resources — are the intellectual property of 2B DIGITAL LLC and are protected by
      ...
      <ul>
        ...
        <li>Copy</li>
        <li>Modify</li>
        <li>Any part of the course or materials without written permission</li>
      </ul>
      <p>Unauthorized distribution may result in legal action.</p>

      <h3>7. Personal Use Only</h3>
      <p>The course is licensed for individual use only. You may not share your login credentials or grant access to third parties.</p>
      <p>Any attempt to redistribute, resell, or share access may result in immediate termination of access without refund.</p>

      <h3>8. No Earnings Guarantee</h3>
      <p>
        The Art of Professional Candles course is educational in nature. We do not guarantee any specific financial results,
        income level, or business success. Your results depend on your own effort, experience, market conditions, and other external factors.
      </p>
      <p>
        By purchasing, you acknowledge that there are risks involved in starting and running a business.
      </p>

      <h3>9. Limitation of Liability</h3>
      <p>To the fullest extent permitted by law, 2B DIGITAL LLC shall not be liable for:</p>
      <ul>
        <li>Any indirect or consequential damages</li>
        <li>Loss of profits</li>
        <li>Business interruptions</li>
        <li>Data loss arising from the use or inability to use our website or products</li>
      </ul>
      <p>Your use of our Services is at your own risk.</p>

      <h3>10. Account Termination</h3>
      <p>We reserve the right to terminate or suspend access to the course without notice if:</p>
      <ul>
        <li>These Terms are violated</li>
        <li>Fraudulent activity is detected</li>
        <li>Intellectual property misuse occurs</li>
      </ul>

      <h3>11. Modifications to the Terms</h3>
      <p>
        We reserve the right to update or modify these Terms at any time. Changes will be effective immediately upon posting on the website.
        It is your responsibility to review these Terms periodically.
      </p>

      <h3>12. Governing Law</h3>
      <p>
        These Terms shall be governed and interpreted in accordance with the laws applicable to 2B DIGITAL LLC,
